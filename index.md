...
venue: "University College Dublin (UCD) Conway Institute"        # brief name of host site without address (e.g., "Euphoric State University")
...
instructor: ["Malvika Sharan, Jason Williams, TBA"] # boxed, comma-separated list of instructors' names as strings, like ["Kay McNulty", "Betty Jennings", "Betty Snyder"]
helper: ["Bérénice Batut, TBA"]     # boxed, comma-separated list of helpers' names, like ["Marlyn Wescoff", "Fran Bilas", "Ruth Lichterman"]
